...
export default async function ContactPage({ params }: Props) {
  ...
  return (
    <div className="max-w-[1200px] mx-auto px-6 py-16">
      ...
      {/* Desktop layout: form | Or | email + socials */}
      <div className="flex flex-col lg:flex-row items-start">
        ...
        {/* "Or" separator — centered between the two columns */}
        ...
        {/* Email + socials — offset to align with the first input (label text-sm + mb-1.5) */}
