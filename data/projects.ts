...
export const projects: Project[] = [
  {
    ...
    techLogos: ['next', 'typescript', 'react', 'supabase', 'postgresql', 'vercel'],
    stack: [
      'Next.js App Router',
      'TypeScript',
      'Tailwind CSS',
    ...
    features: [
      { label: 'Sync quotidienne', icon: 'loading' },
      { label: 'Snapshots historiques', icon: 'dashboard' },
      { label: 'Recherche et filtres', icon: 'api' },
      { label: 'Pages détail modèle', icon: 'route' },
      { label: 'Dashboard data', icon: 'dashboard' },
      { label: 'Graphiques d’évolution', icon: 'chart' },
      { label: 'Filtres persistants', icon: 'route' },
    ],
    demonstrates: [
  ...
  },
  {
    ...
    techLogos: ['javascript', 'react', 'vercel'],
